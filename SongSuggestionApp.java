...
public class SongSuggestionApp extends JFrame {
    ...
    public SongSuggestionApp() {
        ...
        String[] moodOptions = { "Happy", "Sad", "Energetic", "Romantic" };
        moodComboBox = new JComboBox<>(moodOptions);

        String[] genreOptions = { "Pop", "Rock", "Indie", "Hip Hop" };
        ...
        setTitle("Song Recommentation app");
        setSize(500, 300);
    ...
    private void showSuggestions() {
        ...
        if (suggestedSongs.isEmpty()) {
            ...
            for (String song : suggestedSongs) {
                sb.append("sun sathiya-artist=priya saraiya,divya kumar").append(song).append("\n");
            }
            message = sb.toString();
        }
